                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('admin.divisions.store') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control font-monospace text-uppercase" id="code" name="code" value="{{ old('code') }}" required placeholder="e.g. ADMNHR, CONOPS, ACCFIN" autofocus>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g. Administrative & Human Resource, Construction">
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-success btn-sm">Create Division</button>
                                </div>
                            </form>
                        </div>
                    </div>
