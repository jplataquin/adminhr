                ...
                <div class="col-lg-6">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('admin.alert-document-types.update', $alertDocumentType->id) }}">
                                @csrf
                                @method('PUT')

                                <div class="mb-4">
                                    <label for="name" class="form-label small font-weight-bold">Document Type Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $alertDocumentType->name) }}" required placeholder="e.g. Driver's License, Vehicle Registration, Contract" autofocus>
