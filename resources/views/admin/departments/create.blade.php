                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('admin.departments.store') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control font-monospace text-uppercase" id="code" name="code" value="{{ old('code') }}" required placeholder="e.g. OCUSAF, PURCHA, REPMAI">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g. Occupational Safety And Health, Purchasing">
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-info text-dark btn-sm font-weight-bold">Create Department</button>
                                </div>
                            </form>
                        </div>
                    </div>
