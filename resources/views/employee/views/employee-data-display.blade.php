    ...
    <div class="card-body p-4">
            <form action="#">      
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <x-text-input label="Birth Date" id="birthdate" type="date" required="true" value="{{$employee->birthdate}}" data-value="{{$employee->birthdate}}" disabled="true" class="editable"></x-text-input>
                    </div>
        ...
        <div class="card-footer d-flex justify-content-end py-3 bg-body">
            <x-primary-button class="me-2" id="editBtn">Edit</x-primary-button>
            <x-primary-button class="d-none me-2" id="updateBtn">Update</x-primary-button>
