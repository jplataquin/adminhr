...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en-US"> <!--<![endif]-->
    ...
    <body>
        ...
        <div data-controller="/js/controllers/employee_template_id.js">
            ...
            <input data-el="position" type="hidden" value="Position"/>
            
            <h1>Hello World</h1>
            <canvas data-el="canvas" width="638px" height="1016px"></canvas>
        </div>
